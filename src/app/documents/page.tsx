                    ...
                    <tr className="bg-white">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <div className="text-sm font-medium text-gray-900">Sample Contract</div>
                            <div className="text-sm text-gray-500">Added 3 days ago</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex space-x-2 justify-end">
                          <Link href="/documents/sample-id" className="text-indigo-600 hover:text-indigo-900">
                            View
                          </Link>
                          <Link href="/documents/sample-id/edit" className="text-indigo-600 hover:text-indigo-900">
                            Edit
                          </Link>
                        </div>
                      </td>
